...
/**
 * @generated from protobuf service mg.mada_immo.prorietaire.Auth
 */
export interface IAuthClient {
    /**
     * @generated from protobuf rpc: Login(mg.mada_immo.prorietaire.LoginRequest) returns (mg.mada_immo.prorietaire.LoginResponse);
     */
...
/**
 * @generated from protobuf service mg.mada_immo.prorietaire.Biens
 */
export interface IBiensClient {
    /**
     * @generated from protobuf rpc: ListBien(mg.mada_immo.prorietaire.ListBienRequest) returns (mg.mada_immo.prorietaire.ListBienResponse);
     */
    listBien(input: ListBienRequest, options?: RpcOptions): UnaryCall<ListBienRequest, ListBienResponse>;
    /**
     * @generated from protobuf rpc: Get(mg.mada_immo.prorietaire.GetBienRequest) returns (mg.mada_immo.prorietaire.Bien);
     */
    get(input: GetBienRequest, options?: RpcOptions): UnaryCall<GetBienRequest, Bien>;
    /**
     * @generated from protobuf rpc: ListTypeBien(mg.mada_immo.prorietaire.ListTypeBienRequest) returns (mg.mada_immo.prorietaire.ListTypeBienResponse);
     */
...
/**
 * @generated from protobuf service mg.mada_immo.prorietaire.Comptes
 */
export interface IComptesClient {
    /**
     * @generated from protobuf rpc: ChiffreAffaires(mg.mada_immo.prorietaire.ChiffreAffairesRequest) returns (mg.mada_immo.prorietaire.ChiffreAffairesResponse);
     */
